{ config, pkgs, lib, ... }: let
  ...
  home.packages = [ pkgs.colima pkgs.cocoapods pkgs.rubyPackages.xcodeproj colima-docker pkgs.docker-client pkgs.docker-credential-helpers pkgs.docker-credential-gcr];
